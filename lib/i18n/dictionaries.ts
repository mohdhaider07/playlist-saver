...
const en = defineDictionary({
  ...
  profile: {
    ...
    themeSectionDescription: "Choose your preferred display theme.",
    darkMode: "Dark Mode",
    darkModeDescription: "Easier on the eyes. Recommended for extended use.",
    lightMode: "Light Mode",
    lightModeDescription: "Bright and open. Best in well-lit environments.",
    lightModeWarningTitle: "Switch to Light Mode?",
    lightModeWarningDescription:
      "Light mode can cause eye strain during extended use, especially in low-light environments. Dark mode is recommended for a more comfortable experience. Are you sure you want to switch?",
    lightModeWarningConfirm: "Yes, switch to Light Mode",
    lightModeWarningCancel: "Keep Dark Mode",
  },
  playlistPage: {
...
const ar: Dictionary = {
  ...
  profile: {
    ...
    themeSection: "المظهر",
    themeSectionDescription: "اختر نمط العرض المفضل لديك.",
    darkMode: "الوضع الداكن",
    darkModeDescription: "أريح للعيون. موصى به للاستخدام المطوّل.",
    lightMode: "الوضع الفاتح",
    lightModeDescription: "مشرق ومفتوح. مناسب في البيئات ذات الإضاءة الجيدة.",
    lightModeWarningTitle: "التبديل إلى الوضع الفاتح؟",
    lightModeWarningDescription:
      "قد يسبب الوضع الفاتح إجهادًا للعينين عند الاستخدام المطوّل، خاصةً في البيئات ذات الإضاءة الخافتة. يُنصح باستخدام الوضع الداكن للحصول على تجربة مريحة. هل أنت متأكد من التبديل؟",
    lightModeWarningConfirm: "نعم، التبديل إلى الوضع الفاتح",
    lightModeWarningCancel: "الاحتفاظ بالوضع الداكن",
  },
  playlistPage: {
